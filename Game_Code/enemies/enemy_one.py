...
class EnemyOne:
    def __init__(self,level_1,enemy_1_level_1_rect,reset_locations,player_control,level_2,level_3):
        ...
        self.enemy_2_rects=enemy_2_rects ; self.level_2=level_2 ; self.level_2_tile_set_rect=level_2_tile_set_rect ; self.level_3=level_3
        ...
        self.enemy_1_level_3_x=enemy_1_level_3_x ; self.enemy_1_level_3_y=enemy_1_level_3_y
        ...
        if level_3:
            self.enemy_1_rects=enemy_1_level_3_rect
            self.tile_level=self.level_3_tile_set_rect
    ...
    def iscontrolled(self):
        if any([self.level_1,self.level_2,self.level_3]) and self.player_control and self.player_control_cooldown[0]>0  and self.player_control_index[0][1]=="Enemy_1":
    ...
    def collision_with_object(self):
        if any([self.level_1,self.level_2,self.level_3]):
            if EnemyOne.enemy_index(self) not in self.enemy_1_rects:
                return EnemyGeneralFunctions.collision_with_object(self,self.tile_level,self.enemy_1_rects,self.enemy_1_x_movement,self.enemy_1_y_movement)
    ...
    def control_run(self,key):
        if any([self.level_1,self.level_2,self.level_3]) and self.player_control and self.player_control_cooldown[0]>0 and not key[pygame.K_e] and self.player_control_index[0][1]=="Enemy_1":
            if EnemyOne.enemy_index(self)  in self.enemy_1_rects:
                self.enemy_1_rects_control=[i for i in self.enemy_1_rects if i==EnemyOne.enemy_index(self)]
