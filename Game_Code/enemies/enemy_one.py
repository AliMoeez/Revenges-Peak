...
class EnemyOne:
    def __init__(self,level_1,enemy_1_level_1_rect,reset_locations,player_control,level_2,level_3,level_4,level_4_player_talk_2):
        ...
        self.enemy_1_level_4_x=enemy_1_level_4_x ; self.enemy_1_level_4_y=enemy_1_level_4_y
        ...
        if level_4:
            self.enemy_1_rects=enemy_1_level_4_rect
    ...
    def iscontrolled(self):
        if any([self.level_1,self.level_2,self.level_3,self.level_4]) and self.player_control and self.player_control_cooldown[0]>0  and self.player_control_index[0][1]=="Enemy_1":
    ...
    def control_run(self,key):
        if any([self.level_1,self.level_2,self.level_3,self.level_4]) and self.player_control and self.player_control_cooldown[0]>0 and not key[pygame.K_e] and self.player_control_index[0][1]=="Enemy_1":
            if EnemyOne.enemy_index(self)  in self.enemy_1_rects:
                self.enemy_1_rects_control=[i for i in self.enemy_1_rects if i==EnemyOne.enemy_index(self)]
